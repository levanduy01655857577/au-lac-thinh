...
// scroll contact
$('.wrapBtnScrollBottomBannerContact').click(function() {
    var heightMenu = 80;

    if ($(window).width() <= 991) heightMenu = 60;

    var topNextSection = $('.wrapBannerContact').offset().top + $('.wrapBannerContact').height() - heightMenu;

    $('body,html').animate({
        scrollTop: topNextSection
    }, 1000);
});
// end scroll contact
